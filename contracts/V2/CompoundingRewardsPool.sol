...
contract CompoundingRewardsPool is RewardsPoolBase, OneStakerFeature {
	...
	) public RewardsPoolBase(_stakingToken, _startTimestamp, _endTimestamp, _rewardsTokens, _rewardPerBlock, MAX_INT, MAX_INT, _virtualBlockTime) OneStakerFeature(_staker) {
	}
