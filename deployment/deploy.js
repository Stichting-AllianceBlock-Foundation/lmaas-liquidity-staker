...
const deploy = async (network, secret) => {
	...
	const defaultConfigs = {
        ...
        nonce: 7 // Suitable for deploying on private networks like Quorum
    }
	

	const CalculatorInstance = await deployer.deployAndVerify("etherscan", Calculator,defaultConfigs);
