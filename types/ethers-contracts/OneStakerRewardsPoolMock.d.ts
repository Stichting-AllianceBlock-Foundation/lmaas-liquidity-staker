...
interface OneStakerRewardsPoolMockInterface extends ethers.utils.Interface {
  functions: {
...
export class OneStakerRewardsPoolMock extends Contract {
  ...
  interface: OneStakerRewardsPoolMockInterface;
