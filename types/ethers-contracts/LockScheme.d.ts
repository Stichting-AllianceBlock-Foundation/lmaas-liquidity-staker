...
export class LockScheme extends Contract {
  ...
  functions: {
    ...
    "updateUserAccruedRewards(address,uint256)"(
      _userAddress: string,
      _rewards: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
