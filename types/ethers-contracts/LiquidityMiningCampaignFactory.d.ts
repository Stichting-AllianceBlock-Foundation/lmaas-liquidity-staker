...
interface LiquidityMiningCampaignFactoryInterface
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,address[],uint256[],address,uint256,uint256)": FunctionFragment;
    "extendRewardPool(uint256,uint256[],address)": FunctionFragment;
    "setLockSchemesToLMC(address[],address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "extendRewardPool",
    values: [BigNumberish, BigNumberish[], string]
  ): string;
  encodeFunctionData(
    functionFragment: "setLockSchemesToLMC",
    values: [string[], string]
  ): string;
  ...
  events: {
    ...
    "RewardsPoolDeployed(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RewardsPoolDeployed"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RewardsWithdrawn"): EventFragment;
}

export class LiquidityMiningCampaignFactory extends Contract {
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,address[],uint256[],address,uint256,uint256)"(
      _stakingToken: string,
      _startBlock: BigNumberish,
      _endBlock: BigNumberish,
      _rewardsTokens: string[],
    ...
    extendRewardPool(
      ...
      _rewardsPoolAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "extendRewardPool(uint256,uint256[],address)"(
      _endBlock: BigNumberish,
      _rewardsPerBlock: BigNumberish[],
      _rewardsPoolAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "setLockSchemesToLMC(address[],address)"(
      _lockSchemes: string[],
      _rewardsPoolAddress: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    RewardsPoolDeployed(
      rewardsPoolAddress: string | null,
      stakingToken: string | null
    ): TypedEventFilter<
      [string, string],
      { rewardsPoolAddress: string; stakingToken: string }
    >;
