...
interface NonCompoundingRewardsPoolFactoryInterface
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,address[],uint256[],uint256,uint256,uint256,uint256)": FunctionFragment;
  };
...
export class NonCompoundingRewardsPoolFactory extends Contract {
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,address[],uint256[],uint256,uint256,uint256,uint256)"(
      _stakingToken: string,
      _startBlock: BigNumberish,
      _endBlock: BigNumberish,
      _rewardsTokens: string[],
