...
interface CompoundingRewardsPoolFactoryInterface
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
  };
...
export class CompoundingRewardsPoolFactory extends Contract {
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,uint256,uint256,uint256,uint256,uint256)"(
      _stakingToken: string,
      _startBlock: BigNumberish,
      _endBlock: BigNumberish,
      _rewardPerBlock: BigNumberish,
