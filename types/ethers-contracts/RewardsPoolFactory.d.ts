...
interface RewardsPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "deploy(address,uint256,uint256,address[],uint256[],uint256,uint256)": FunctionFragment;
...
export class RewardsPoolFactory extends Contract {
  ...
  interface: RewardsPoolFactoryInterface;
  ...
  functions: {
    ...
    "deploy(address,uint256,uint256,address[],uint256[],uint256,uint256)"(
      _stakingToken: string,
      _startBlock: BigNumberish,
      _endBlock: BigNumberish,
      _rewardsTokens: string[],
