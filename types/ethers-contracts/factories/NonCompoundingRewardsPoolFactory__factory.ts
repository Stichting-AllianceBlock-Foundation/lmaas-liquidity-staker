...
import type { NonCompoundingRewardsPoolFactory } from "../NonCompoundingRewardsPoolFactory";

export class NonCompoundingRewardsPoolFactory__factory {
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as NonCompoundingRewardsPoolFactory;
  }
}
