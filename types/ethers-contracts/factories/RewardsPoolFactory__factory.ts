...
import type { RewardsPoolFactory } from "../RewardsPoolFactory";

export class RewardsPoolFactory__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RewardsPoolFactory {
    return new Contract(address, _abi, signerOrProvider) as RewardsPoolFactory;
  }
}
